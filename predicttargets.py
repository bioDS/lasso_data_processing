...
# Paths
CS_SCRIPT = "/home/kieran/work/tscan60/targetscan_61_context_scores/targetscan_60_context_scores.pl"
UTR_FILE = "/home/kieran/work/tscan_wrapper/data/hg19_ucsc_3p.txt"
SCANNED_SEEDS_DIR = "/home/kieran/work/infx_lasso_data/tscan60/"
TRANSLATION = "/home/kieran/work/tscan_wrapper/data/refseq.txt"
...
def prepare(sirna_id, sirna_seq, species="9606"):
    ...
    seedsf = open(SCANNED_SEEDS_DIR + "/tscan." + sirna_seq[1:8] + ".txt", "r")
    print("reading seeds file {}".format(SCANNED_SEEDS_DIR + "/tscan." + sirna_seq[1:8] + ".txt", "r"))
...
def predict(mat_seq_file_name, ts_pred_file_name):
    ...
    print(CS_SCRIPT)
    print(mat_seq_file_name)
    print(UTR_FILE)
    print(ts_pred_file_name)
    print(contextplus_score_file.name)
...
def main():
    ...
    # Write out targets
    counter = 0
    outf_name = "{}/{}.txt".format(options.out, options.id)
    while (os.path.isfile(outf_name)):
        counter = counter + 1
        outf_name = "{}/{}.txt.{}".format(options.out, options.id, counter)
    print("using outf {}".format(outf_name))
